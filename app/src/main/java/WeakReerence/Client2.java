...
public class Client2 {
    public static void main(String[] args) {
        ...
        System.out.println(appleWeakReference.hashCode());
        System.out.println(appleWeakReference2.hashCode());
        ...
        while ((reference2 = appleReferenceQueue.poll()) != null ) {
            //如果使用继承的方式就可以包含其他信息了
            System.out.println("appleReferenceQueue中：" + reference2.hashCode());
        }
    }
}
